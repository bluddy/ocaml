  ...
  struct
    ...
    let erased_names_of_constraints constraints acc =
      List.fold_right (fun constraint_ acc ->
        ...
        | Parsetree.Pwith_type _ | Parsetree.Pwith_module _ | Parsetree.Pwith_modtype _
        | Parsetree.Pwith_effect _ -> acc
        ...
        | Parsetree.Pwith_effectsubst (s, eff) ->
            constraint_for_subitem acc s
              (fun s -> Parsetree.Pwith_effectsubst (s, eff)))
        constraints acc
    ...
    *)
    ...
    and analyse_signature_item_desc env _signat table current_module_name
        ...
        match sig_item_desc with
          Parsetree.Psig_value {Parsetree.pval_name=name_pre; pval_attributes=attrs}
        | Parsetree.Psig_primitive {Parsetree.pprim_name=name_pre; pprim_attributes=attrs} ->
